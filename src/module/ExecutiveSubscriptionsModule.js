...
const nowIso8601 = moment("2020-08-31").date(1).format("YYYY-MM-DD");
const nextIso8601 = moment("2020-08-31")
  .add(1, "month")
  .date(1)
  .format("YYYY-MM-DD");
      ...
      <table className="subscription-table">
        <thead>
          <tr>
            <th>生徒</th>
            <th>ステータス</th>
            <th>{moment("2020-08-31").month() + 1}月</th>
            <th>補講</th>
            <th>{moment("2020-08-31").add(1, "month").month() + 1}月</th>
            <th>補講</th>
          </tr>
        </thead>
